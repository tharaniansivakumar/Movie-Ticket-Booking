...
/**
 * Servlet implementation class SeatAdmin
 */
@WebServlet("/seatadmin")
public class SeatAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SeatAdminService service=new SeatAdminService();
		 Showservice show=new Showservice();
		 Show ser=show.retrive(user);
		 String date=ser.getDate();
		 String time=ser.getShowTime();
		List scr=(List) service.retrive(date,time);
