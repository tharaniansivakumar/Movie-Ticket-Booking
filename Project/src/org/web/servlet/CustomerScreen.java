...
/**
 * Servlet implementation class CustomerScreen
 */
@WebServlet("/customerscreen")
public class CustomerScreen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(PrintWriter out=response.getWriter())
		{
			...
			CustomerMovieService service=new CustomerMovieService();
			Screen scr=service.retrive(user);
